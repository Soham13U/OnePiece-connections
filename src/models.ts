...
// Shared tag metadata used by both the tagger and the puzzle generator.
export const TAGS: TagInfo[] = [
  ...
  { tag: 'crew:revolutionary-army', dimension: 'crew', label: 'Revolutionary Army', difficulty: 'medium' },
  { tag: 'crew:cp', dimension: 'crew', label: 'Cipher Pol', difficulty: 'hard' },
  { tag: 'crew:shichibukai', dimension: 'crew', label: 'Former Warlords of the Sea', difficulty: 'medium' },
  ...
  { tag: 'crew:nefertari-family', dimension: 'crew', label: 'Nefertari Family', difficulty: 'hard' },
  { tag: 'crew:riku-family', dimension: 'crew', label: 'Riku Family', difficulty: 'hard' },
  { tag: 'crew:vinsmoke-family', dimension: 'crew', label: 'Vinsmoke Family', difficulty: 'hard' },
  { tag: 'crew:fishman-island', dimension: 'crew', label: 'Fish-Man Island factions', difficulty: 'medium' },
  ...
  { tag: 'role:fleet-admiral', dimension: 'role', label: 'Fleet Admirals', difficulty: 'hard' },
  ...
  { tag: 'role:warden', dimension: 'role', label: 'Impel Down Wardens', difficulty: 'medium' },
  ...
  { tag: 'fruit:mythical-zoan', dimension: 'fruit', label: 'Mythical Zoan users', difficulty: 'hard' },
  { tag: 'fruit:awakened-paramecia', dimension: 'fruit', label: 'Awakened Paramecia users', difficulty: 'hard' },
  { tag: 'fruit:awakened-zoan', dimension: 'fruit', label: 'Awakened Zoan users', difficulty: 'hard' },

  // Haki
  { tag: 'haki:observation', dimension: 'haki', label: 'Observation Haki users', difficulty: 'easy' },
  { tag: 'haki:armament', dimension: 'haki', label: 'Armament Haki users', difficulty: 'easy' },
  { tag: 'haki:conqueror', dimension: 'haki', label: 'Conqueror’s Haki users', difficulty: 'medium' },
  { tag: 'haki:all-three', dimension: 'haki', label: 'Users of all three Haki types', difficulty: 'hard' },
  ...
  { tag: 'origin:west-blue', dimension: 'origin', label: 'From West Blue', difficulty: 'medium' },
  { tag: 'origin:north-blue', dimension: 'origin', label: 'From North Blue', difficulty: 'medium' },
  { tag: 'origin:south-blue', dimension: 'origin', label: 'From South Blue', difficulty: 'medium' },
  { tag: 'origin:grand-line', dimension: 'origin', label: 'From the Grand Line', difficulty: 'medium' },
  { tag: 'origin:new-world', dimension: 'origin', label: 'From the New World', difficulty: 'medium' },
  { tag: 'origin:dressrosa', dimension: 'origin', label: 'From Dressrosa', difficulty: 'hard' },
  { tag: 'origin:alabasta', dimension: 'origin', label: 'From Alabasta', difficulty: 'hard' },
  ...
  // Meta
  { tag: 'meta:clan-of-d', dimension: 'meta', label: 'Bearers of the D.', difficulty: 'medium' },
  { tag: 'meta:yonko', dimension: 'meta', label: 'Four Emperors', difficulty: 'hard' },
  { tag: 'meta:former-warlord', dimension: 'meta', label: 'Former Warlords', difficulty: 'medium' },
  { tag: 'meta:worst-generation', dimension: 'meta', label: 'Worst Generation members', difficulty: 'medium' },
  
  // Combined tags: Status + Haki
  { tag: 'meta:deceased-conqueror', dimension: 'meta', label: 'Deceased Conqueror\'s Haki users', difficulty: 'hard' },
  { tag: 'meta:deceased-all-three-haki', dimension: 'meta', label: 'Deceased users of all three Haki types', difficulty: 'hard' },
  
  // Combined tags: Status + Fruit
  { tag: 'meta:deceased-logia', dimension: 'meta', label: 'Deceased Logia users', difficulty: 'hard' },
  { tag: 'meta:deceased-paramecia', dimension: 'meta', label: 'Deceased Paramecia users', difficulty: 'medium' },
  { tag: 'meta:deceased-zoan', dimension: 'meta', label: 'Deceased Zoan users', difficulty: 'medium' },
  
  // Combined tags: Status + Role
  { tag: 'meta:deceased-captain', dimension: 'meta', label: 'Deceased Captains', difficulty: 'hard' },
  { tag: 'meta:deceased-admiral', dimension: 'meta', label: 'Deceased Admirals', difficulty: 'hard' },
  
  // Combined tags: Crew + Origin
  { tag: 'meta:straw-hats-east-blue', dimension: 'meta', label: 'Straw Hat Pirates from East Blue', difficulty: 'medium' },
  { tag: 'meta:straw-hats-grand-line', dimension: 'meta', label: 'Straw Hat Pirates from Grand Line', difficulty: 'medium' },
  { tag: 'meta:marines-grand-line', dimension: 'meta', label: 'Marines from Grand Line', difficulty: 'medium' },
  { tag: 'meta:marines-new-world', dimension: 'meta', label: 'Marines from New World', difficulty: 'hard' },
  { tag: 'meta:traitor', dimension: 'meta', label: 'Traitors', difficulty: 'hard' },
];
